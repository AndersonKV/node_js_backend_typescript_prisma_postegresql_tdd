...
Api Backend feito utilizando node js com typescript e prisma, utilizando principios solid e com cobertura de testes, tanto e2e, unit, integration, além de autenticação, upload de fotos</br>
